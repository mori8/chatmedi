...
const ChatMessages: React.FC<ChatMessagesProps> = ({ messages, user, tempChatMediResponse, isFetching, setIsModalOpen }) => {
  return (
    <>
        ...
        >
          <div className="profile-image flex-shrink-0">
            <img
              ...
              src={message.sender === "user" ? user?.image! : "/images/robot-1.svg"}
              alt={message.sender}
            />
          </div>
          <span
          ...
          >
            {"prompt" in message ? (
              ...
              <>
                {message.response ? (
                  <ChatResponse response={message.response} setIsModalOpen={setIsModalOpen} />
                ) : (
      ...
      {isFetching && tempChatMediResponse && (
        <div className="flex gap-4 justify-start">
          ...
          <span className="prose">
            <ChatResponse response={tempChatMediResponse} setIsModalOpen={setIsModalOpen} />
          </span>
        </div>
      )}
    </>
